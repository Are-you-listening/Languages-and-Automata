...
DFA::DFA(const string &fileName) : automaat(fileName) {
    type = "DFA";
}
...
void DFA::eliminateState(std::string eliminatedstate) {
...
RE DFA::toRE() {
    //copy the current DFA and move the connections to regexconnections, before eliminating any states
    bool sorted;
    do {
