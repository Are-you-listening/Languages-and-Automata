...
bool DFA::is_end_state(const string &state) {
    /**
...
void DFA::disqualified(const string &state1, const string &state2, const map<string , map<char, string>>& trans_map, map<string, map<string, bool>>& tfa_map, const set<string>& p_states) {
    /**
...
void DFA::set_table_filling_map(const string &state1, const string &state2, bool b, map<string, map<string, bool>>& tfa_map) {
    /**
...
bool DFA::in_table_filling_map(const string &state1, const string &state2, bool b, const map<string, map<string, bool>>& tfa_map) {
    /**
...
DFA DFA::minimize() {
    ...
    DFA mindfa(alfabet, new_states, new_transition_map, new_start_state, new_end_states);
    return mindfa;
...
string DFA::set_to_string(const set<string> &s) const {
    /**
...
DFA::DFA(const set<char> &alfabet, const set<string> &states, const map<string, map<char, string>> &transition_map,
...
const map<string, map<char, string>> &DFA::getTransitionMap() const {
    return transition_map;
}

const set<string> &DFA::getStates() const {
    return states;
}
...
const set<char> &DFA::getAlfabet() const {
    return alfabet;
}

const set<string> &DFA::getEndStates() const {
    return end_states;
}

pair<set<string>, bool> DFA::get_eq(const string &state, const vector<set<string>> &equiv_vect) {
...
void DFA::add_eq(const string &state, const set<string> &eq, vector<set<string>>& equiv_vect) {
    for (auto &v: equiv_vect){
        if (eq == v){
            v.insert(state);
        }
...
void DFA::printTable(const set<string> &p_states, const map<string, map<string, bool>> &tfa_map) {
    set<string>::iterator it;
    set<string>::iterator it2;
    int index = 0;
