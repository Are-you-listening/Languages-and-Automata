...
int Song::similarity(Song &song) const {
    ...
    //IDEA KARS
    auto t = song.toRegex(0,1,1,1,0,1,1); // als je een hogere match precentage wilt dat nog steeds accuraat is, maak instrument 0 en velocity 0 song.toRegex(0,1,0,1,0,1, 1);
